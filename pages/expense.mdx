...
Confirm that the Expense Approvals page is displayed.

### Add Approval

Click on "Add Approval" on the top right corner of the page

### Fill Mandatory Fields

Provide an Approval Name, Set Priority, and Add a Description. Ensure all mandatory fields are completed accurately.

### Define Criteria and Rules

Set criteria for triggering the approval flow. Define rules and conditions using the "+Rule" button
...
Select the type of approval flow Individual,Department Head, Managerial Hierarchy, User Group, etc.) and enter the flow name.

### Configure User Group Flow

If User Group is chosen, specify the User Group, and set approval options (Any, All, Percentage).

### Add Additional Approval Flows

If needed, add more approval flows and prioritise them using drag-and-drop.

### Auto Approve/Reject

Optionally, choose "Auto Approve" or "Auto Reject" for automatic decisions based on predefined rules.
...
Verify that the added approval is visible in the respective tab with accurate information.

### Additional Actions

Utilise actions like editing and copying if required

### Approval Workflow Tab

Access the Approval Workflow Tab available in expense detail to monitor and manage different approval levels
